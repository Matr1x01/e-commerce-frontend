...
const WishListProductCard = ({product, deleteWishlistProduct}) => {
    ...
    return (
        <div
            className="flex flex-row items-center justify-between border-b bg-theme-cardBg p-8 rounded-2xl text-theme-textOnLight">
            <Link href={`/products/${product.product_slug}`}>
                <div className="flex flex-row items-center">
                    <Image unoptimized src={imgSrc} alt={product.product_name} className="mr-4" width={100}
                           height={100}/>
                    <div className="ml-4">
